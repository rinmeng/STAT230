	...
	\begin{enumerate}
		...
		\begin{tikzpicture}
			\draw[fill=black!0] (0,0) rectangle (12,7);
  			...
  			\draw[fill=blue!0] (5,2.5) circle (1.5cm); % Circle B
  			\draw[fill=blue!0] (7,2.5) circle (1.5cm); % Circle C
		...
		\begin{tikzpicture}
			\draw[fill=black!0] (0,0) rectangle (12,7);
  			\draw[fill=blue!20] (6,4.5) circle (1.5cm); % Circle A
  			\draw[fill=blue!20] (7,2.5) circle (1.5cm); % Circle C
  			\draw[fill=blue!20] (5,2.5) circle (1.5cm); % Circle B
  			\draw (6,4.5) circle (1.5cm); % Outline of Circle A
  			\draw (5,2.5) circle (1.5cm); % Outline of Circle B
  			\draw (7,2.5) circle (1.5cm); % Outline of Circle C
  			\node at (6,5) {A}; % Label for Circle A
		...
		\begin{tikzpicture}
			\draw[fill=black!0] (0,0) rectangle (12,7);
  			...
  			\begin{scope} % Scope for transparency
    			...
    			\fill[blue!20] (6,4.5) circle (1.5cm); % Circle A
  			\end{scope}
